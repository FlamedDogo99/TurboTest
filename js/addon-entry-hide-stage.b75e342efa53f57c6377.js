(window.webpackJsonpGUI = window.webpackJsonpGUI || []).push([[33], {
    ...
    1618: function(e, s, a) {
        ...
        var n = a(1600);
        const r = {
            "userscript.js": async function({addon: e, console: s, msg: a}) {
                let n,
                    r,
                    i,
                    d,
                ...
                function c() {
                    o = !0,
                    n && (document.body.classList.add("sa-stage-hidden-outer"), n.classList.add("sa-stage-hidden"), d.classList.remove(e.tab.scratchClass("stage-header_stage-button-toggled-off")), window.dispatchEvent(new Event("resize")))
                }
                function g(s) {
                    o = !1,
                    n && (document.body.classList.remove("sa-stage-hidden-outer"), n.classList.remove("sa-stage-hidden"), d.classList.add(e.tab.scratchClass("stage-header_stage-button-toggled-off")), window.dispatchEvent(new Event("resize")))
                }
                for (e.self.addEventListener("disabled", () => g());;) {
                    const s = await e.tab.waitForElement("[class*='stage-header_stage-size-toggle-group_']", {
                        markAsSeen: !0,
                        reduxCondition: e => !e.scratchGui.mode.isPlayerOnly
                    });
                    n = document.querySelector("[class*='gui_body-wrapper_']"),
                    r = s.firstChild,
                    r.classList.add("sa-stage-button-middle"),
                    i = s.lastChild,
                    d = Object.assign(document.createElement("div"), {
                        role: "button",
                        className: e.tab.scratchClass("button_outlined-button", "stage-header_stage-button", "stage-header_stage-button-first", {
                            others: "sa-hide-stage-button"
                        })
                    }),
                    e.tab.displayNoneWhileDisabled(d),
                    s.insertBefore(d, r),
                    d.appendChild(Object.assign(document.createElement("img"), {
                        className: e.tab.scratchClass("stage-header_stage-button-icon"),
                        src: t("/icon.svg"),
                        alt: a("hide-stage"),
                        draggable: !1
                    })),
