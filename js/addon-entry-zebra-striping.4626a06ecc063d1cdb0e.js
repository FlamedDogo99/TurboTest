    ...
    1635: function(e, t, r) {
        ...
        const n = {
            "userscript.js": async function({addon: e, msg: t, console: r}) {
                ...
                for (n.BlockSvg.prototype.render = function(e) {
                    if (!this.isInFlyout && !this.isShadow() && null === this.getParent()) {
                        const e = new Map;
                        for (const t of this.getDescendants()) {
                            const r = t.getSurroundParent();
                            let i = !1;
                            r && (t.isShadow() ? i = !!e.get(r) : r.getCategory() === t.getCategory() && (i = !e.get(r))),
                            e.set(t, i);
                            const n = [t.svgPath_];
                            ...
                            for (const e of n)
                                e.classList.toggle("sa-zebra-stripe", i)
                        }
                    }
                    return a.call(this, e)
                }, i.editingTarget && i.emitWorkspaceUpdate();;) {
                    const t = await e.tab.waitForElement('filter[id*="blocklyReplacementGlowFilter"]', {
                        markAsSeen: !0,
                        reduxEvents: ["scratch-gui/mode/SET_PLAYER", "fontsLoaded/SET_FONTS_LOADED", "scratch-gui/locales/SELECT_LOCALE"],
                        reduxCondition: e => !e.scratchGui.mode.isPlayerOnly
                    });
                    document.documentElement.style.setProperty("--zebraStriping-replacementGlow", "url(#".concat(t.id, ")"))
                }
            },
